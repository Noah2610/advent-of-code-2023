                ...
                new SequenceParser<>(List.of(
                        ...
                        new RepeatParser<>(new SequenceParser<>(List.of(
                                new OneOfParser<>(List.of(
                                        new MapperParser<>(new TokenParser("seed-to-soil" + " map:"),
                                                (_s) -> new SeedToSoil()),
                                        new MapperParser<>(new TokenParser("soil-to-fertilizer" + " map:"),
                                                (_s) -> new SoilToFertilizer()),
                                        new MapperParser<>(new TokenParser("fertilizer-to-water" + " map:"),
                                                (_s) -> new FertilizerToWater()),
                                        new MapperParser<>(new TokenParser("water-to-light" + " map:"),
                                                (_s) -> new WaterToLight()),
                                        new MapperParser<>(new TokenParser("light-to-temperature" + " map:"),
                                                (_s) -> new LightToTemperature()),
                                        new MapperParser<>(new TokenParser("temperature-to-humidity" + " map:"),
                                                (_s) -> new TemperatureToHumidity()),
                                        new MapperParser<>(new TokenParser("humidity-to-location" + " map:"),
                                                (_s) -> new HumidityToLocation()))),
                                new NewlineParser(),
                                new RepeatParser<>(new SequenceParser<>(List.of(
                                        new MapperParser<>(
                                                new SequenceParser<>(List.of(
